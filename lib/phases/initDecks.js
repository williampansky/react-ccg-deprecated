const deckInfo = require('lib/state/deck-info');
const CARDCLASS = require('enums/cardClass.enums');
...
const initDecksPhase = {
  ...
  onBegin: (G, ctx) => {
    const p1deck = NECROMANCER;
    const p2deck = BERSERKER;
    ...
    G.playerClass['0'] = CARDCLASS[7];
    G.playerClass['1'] = CARDCLASS[9];
  },
